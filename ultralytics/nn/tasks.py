...
class DistLoss(v8DetectionLoss): 
    ...
    def __call__(self, preds, batch):
        ...
        if fg_mask.sum():
            ...
            loss_value = loss_value  /4 
            loss[2] = loss_value.mean() # / target_scores_sum
            loss[0] = loss[0] + dl/5
        """ 
        if loss_value<1:
        ...
        """
        loss_sum = loss[0]*self.hyp.box + loss[1]*self.hyp.cls + loss[2]*self.hyp.dfl
        
        return loss_sum * batch_size, loss.detach() 
